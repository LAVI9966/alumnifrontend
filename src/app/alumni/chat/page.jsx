  ...
  return (
    <div className={`w-full ${isDark ? 'bg-[#131A45]' : 'bg-cyan-400'}`}>
      <div className={`min-h-screen max-w-[1200px] w-full mx-auto flex gap-3  ${isDark ? 'bg-[#2A3057]' : 'bg-cyan-300'}  pt-8 `}>
        ...
        <div className={`max-w-[900px] w-full lg:w-[75%]  mx-auto  ${isDark ? 'bg-[#2A3057]' : 'bg-cyan-300'} shadow-lg rounded-lg  h-[600px]  hidden lg:flex flex-col `}>
          {/* Header */}
          <div className={`flex items-center justify-between py-3 px-4  ${isDark ? 'bg-[#2A3057]' : 'bg-cyan-300'}  border-b border-[#D9D9D9]`}>
          ...
          <form
            ...
            className={`flex items-center border-t border-gray-300 p-3  ${isDark ? 'bg-[#2A3057]' : 'bg-cyan-300'}`}
          >
            <input
              type="text"
