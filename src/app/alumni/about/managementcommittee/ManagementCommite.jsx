...
const ManagementCommitee = () => {
    ...
    return (
        <div id='managementcommittee' className={`w-full ${isDark ? '' : 'bg-[#F2F2F2]'}`}>
                ...
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-10">
                    ...
                    <div className="md:w-[380px] text-center md:text-left shrink-0 mb-6 md:mb-0">
                        <div className="inline-block">
                            ...
                            <h2 className={`text-[36px] md:text-[40px] font-extrabold leading-tight ${isDark ? '' : 'bg-[#F2F2F2]'} tracking-tight whitespace-nowrap`}>
