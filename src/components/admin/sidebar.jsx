...
const AdminSidebar = () => {
  ...
  return (
    <aside className={`w-64 p-4 space-y-6 border-r-[1px] flex flex-col justify-between ${isDark ? 'bg-[#232B4A] text-white border-[#232B4A]' : 'bg-white text-custom-blue border-[#E5E5E5]'}`}>
      <nav>
        <Link href="/admin/homepage">
          <Image
            ...
            src="/logoimage.png"
            alt="Rimcollian Logo"
            className={`h-[85px] ml-3 w-[85px] ${isDark ? 'bg-white rounded-full' : 'bg-[#F2F2F2] rounded-full'}`}
          />
        </Link>
